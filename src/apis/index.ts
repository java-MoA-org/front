...
import {
  PatchUsedTradeRequestDto,
  PostUsedTradeRequestDto,
} from "./dto/request/usedtrade";
import {
  GetUsedTradeListResponseDto,
  GetUsedTradeResponseDto,
} from "./dto/response/usedtrade";
...
export const SNS_SIGN_IN_URL = (sns: "kakao" | "naver") =>
  `${AUTH_MODULE_URL}/sns/${sns}`;
const SIGN_OUT_URL = `${AUTH_MODULE_URL}/sign-out`;

const PATCH_PASSWORD_URL = (userId: string) =>
  `${AUTH_MODULE_URL}/${userId}/password`;
...
const GET_BOARD_URL = (boardSequence: number | string) =>
  `${BOARD_MODULE_URL}/${boardSequence}`;
const PATCH_BOARD_URL = (boardSequence: number | string) =>
  `${BOARD_MODULE_URL}/${boardSequence}`;
const DELETE_BOARD_URL = (boardSequence: number | string) =>
  `${BOARD_MODULE_URL}/${boardSequence}`;
...
const GET_DAILY_URL = (dailySequence: number | string) =>
  `${DAILY_MODULE_URL}/${dailySequence}`;
const GET_DAILY_LIST_URL = (page: number, sort = "LATEST") =>
  `${DAILY_MODULE_URL}/${page}?sortOption=${sort}`;
const PATCH_DAILY_URL = (dailySequence: number | string) =>
  `${DAILY_MODULE_URL}/${dailySequence}`;
const DELETE_DAILY_URL = (dailySequence: number | string) =>
  `${DAILY_MODULE_URL}/${dailySequence}`;
...
const DELETE_USED_TRADE_URL = (tradeSequence: number | string) =>
  `${USED_TRADE_MODULE_URL}/${tradeSequence}`;
const SEARCH_USED_TRADE_LIST_URL = (
  tag: string,
  keyword: string,
  page: number,
) =>
...
const GET_USER_PAGE_URL = (nickname: string) =>
  `${USER_PAGE_MODULE_URL}/boards/${nickname}`;
...
export const userIdCheckRequest = async (
  requestBody: UserIdCheckRequestDto,
) => {
...
export const userNicknameCheckRequest = async (
  requestBody: UserNicknameCheckRequestDto,
) => {
  const responseBody = await axios
...
export const userEmailCheckRequest = async (
  requestBody: UserEmailCheckRequestDto,
) => {
  const responseBody = await axios
...
export const UserEmailVerifyRequest = async (
  requestBody: UserEmailVerifyRequestDto,
) => {
  const responseBody = await axios
...
export const userEmailCheckFindIdRequest = async (
  requestBody: UserEmailCheckRequestDto,
) => {
  const responseBody = await axios
...
export const UserEmailFindIdVerifyRequest = async (
  requestBody: UserEmailVerifyRequestDto,
) => {
  const responseBody = await axios
...
export const userPhoneNumberCheckRequest = async (
  requestBody: UserPhoneNumberCheckRequestDto,
) => {
  const responseBody = await axios
...
export const PatchPasswordRequest = async (
  requestBody: PatchPasswordRequestDto,
) => {
  const responseBody = await axios
...
export const searchBoardRequest = async (
  ...
  const responseBody = await axios
    .get(
      SEARCH_BOARD_LIST_URL(tag, keyword, page),
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler<GetBoardListResponseDto>)
    .catch(responseErrorHandler);
...
export const toggleBoardLikeRequest = async (
  boardSequence: number | string,
  accessToken: string,
) => {
  const responseBody = await axios
    .put(
      TOGGLE_BOARD_LIKE_URL(boardSequence),
      {},
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
...
export const postBoardCommentRequest = async (
  ...
  const responseBody = await axios
    .post(
      POST_BOARD_COMMENT_URL(boardSequence),
      requestBody,
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
...
export const deleteBoardCommentRequest = async (
  ...
  const responseBody = await axios
    .delete(
      DELETE_BOARD_COMMENT_URL(commentSequence),
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
    .catch(responseErrorHandler);
...
export const postDailyRequest = async (
  requestBody: PostDailyRequestDto,
  accessToken: string,
) => {
  const responseBody = await axios
...
export const getDailyRequest = async (
...
export const deleteDailyRequest = async (
  dailySequence: number | string,
  accessToken: string,
) => {
  const responseBody = await axios
...
export const toggleDailyLikeRequest = async (
  dailySequence: number | string,
  accessToken: string,
) => {
  const responseBody = await axios
    .put(
      PUT_DAILY_LIKES_URL(dailySequence),
      {},
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
...
export const getDailyLikesRequest = async (
  dailySequence: number | string,
  accessToken: string,
) => {
  const responseBody = await axios
...
export const postDailyCommentRequest = async (
  ...
  const responseBody = await axios
    .post(
      POST_DAILY_COMMENT_URL(dailySequence),
      requestBody,
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
...
export const deleteDailyCommentRequest = async (
  ...
  const responseBody = await axios
    .delete(
      DELETE_DAILY_COMMENT_URL(commentSequence),
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
    .catch(responseErrorHandler);
...
export const getUsedTradeRequest = async (
...
export const getUsedTradeListRequest = async (
  ...
  const responseBody = await axios
    .get(
      GET_USED_TRADE_LIST_URL(tag, page, sort),
      bearerAuthorization(accessToken),
    )
...
export const patchUsedTradeRequest = async (
  ...
  const responseBody = await axios
    .patch(
      PATCH_USED_TRADE_URL(tradeSequence),
      requestBody,
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
...
export const deleteUsedTradeRequest = async (
  ...
  const responseBody = await axios
    .delete(
      DELETE_USED_TRADE_URL(tradeSequence),
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
    .catch(responseErrorHandler);
...
export const searchUsedTradeRequest = async (
  ...
  const responseBody = await axios
    .get(
      SEARCH_USED_TRADE_LIST_URL(tag, keyword, page),
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler<GetUsedTradeListResponseDto>)
    .catch(responseErrorHandler);
...
export const toggleUsedTradeLikeRequest = async (
  tradeSequence: number | string,
  accessToken: string,
) => {
  const responseBody = await axios
    .put(
      TOGGLE_USED_TRADE_LIKE_URL(tradeSequence),
      {},
      bearerAuthorization(accessToken),
    )
    .then(responseSuccessHandler)
