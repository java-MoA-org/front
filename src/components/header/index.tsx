...
import { userSignOutRequest } from "../../apis";
            ...
            >
              ...
              {activeMenu === menu && (
                <div className="dropdown-fix">
                  ...
                  {menu === "게시판" && (
                    <>
                      <p onClick={() => navigate(BOARD_WRITE_ABSOLUTE_PATH)}>
                        게시글 작성
                      </p>
                  ...
                  {menu === "일상" && (
                    <>
                      <p onClick={() => navigate(DAILY_WRITE_ABSOLUTE_PATH)}>
                        일상글 작성
                      </p>
                  ...
                  {menu === "중고거래" && (
                    <>
                      <p
                        onClick={() => navigate(USED_TRADE_WRITE_ABSOLUTE_PATH)}
                      >
                        판매글 작성
                      </p>
