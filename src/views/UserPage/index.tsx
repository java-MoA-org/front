                ...
                <div className='my-user-container'>
                    <div className='profile'>
                        <div className='profile-container'>
                            ...
                            <div className='profile-image'><img src={userImage} alt="User" className='profile-img'/></div>
                            ...
                            <div className='follower-followee-container'>
                                ...
                                <div className='following'>
                                    <div className='followee'>팔로잉</div>
                                    <div className='number'>0</div>
                                </div>
                            </div>
                    ...
                    <div className='board-container'>
                        ...
                        <div className='board-type'>
                            ...
                            <div className='board-type-used'>중고 거래
                                <div className='board-content'>
                                        <div className='board-number'>1</div>
                                        <div className='board-title'>날씨가 좋디</div>
                                        <div className='board-view'>10</div>
                            ...
                            <div className='board-type-just'>게시글
                            <div className='board-content'>
                                        <div className='board-number'>1</div>
                                        <div className='board-title'>날씨가 좋디</div>
                                        <div className='board-view'>10</div>
