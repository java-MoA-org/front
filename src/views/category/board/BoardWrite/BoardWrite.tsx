      ...
      <div className='write-container'>
        ...
        <div className='contents-container'>
          ...
          <div className='input-row-box'>
            ...
            <div className={gameContentClass} onClick={() => onBoardTagTypeChangeHandler(BoardTagType.GAME)}>
              게임
            </div>
            <div className={travelContentClass} onClick={() => onBoardTagTypeChangeHandler(BoardTagType.TRAVEL)}>
              여행
            </div>
            <div className={workoutContentClass} onClick={() => onBoardTagTypeChangeHandler(BoardTagType.WORKOUT)}>
              운동
            </div>
            <div className={musicContentClass} onClick={() => onBoardTagTypeChangeHandler(BoardTagType.MUSIC)}>
              음악
            </div>
            <div className={economyContentClass} onClick={() => onBoardTagTypeChangeHandler(BoardTagType.ECONOMY)}>
              경제
            </div>
            <div className={fashionContentClass} onClick={() => onBoardTagTypeChangeHandler(BoardTagType.FASHION)}>
              패션
            </div>
            <div className={foodContentClass} onClick={() => onBoardTagTypeChangeHandler(BoardTagType.FOOD)}>
              음식
            </div>
          </div>
