...
import { PatchPasswordRequest, userEmailCheckFindIdRequest, UserEmailFindIdVerifyRequest } from '../../../apis';
                ...
                {userEmailVerified && userId == emailUserId && (
                    <div className="find-password-result-container">
                        ...
                        <div className="patch-button-container">
                            <div className={buttonClass} onClick={onPatchPasswordClickHandler}>
                                비밀번호 변경
                            </div>
                        </div>
                    </div>
